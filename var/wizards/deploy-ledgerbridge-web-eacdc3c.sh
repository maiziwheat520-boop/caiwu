...
EXPECTED_REVISION=eacdc3c19b79012fa4a6d5eae6ebcbe9dc88e737
EXPECTED_ARCHIVE_SHA256=d74c471b63abe2ef2d2d68cf97eae5c1ecb3597f269cd189693e351825b3b7d5
EXPECTED_CORE_MIGRATION=20260831_0026
ARCHIVE=/home/aiadmin/private-releases/ledgerbridge-web/eacdc3c19b79/release.tar.gz
...
PY
  ...
  printf 'CLASSIFICATION_GROUPS_PROBE_OK version=v1 groups=valid-list\n' >&2
  printf '1\n'
}
