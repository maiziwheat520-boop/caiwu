...
GENERIC_BANK_STATEMENT_IMPORT_REVISION = "20260902_0030"
BOC_ABC_BANK_STATEMENT_IMPORT_REVISION = "20260902_0031"
...
REPORTING_ITEM_CORRECTION_REVISION = "20260905_0049"
POSTED_SNAPSHOT_TRIGGER_REPAIR_REVISION = "20260906_0050"
...
COMPANY_TRANSACTION_CLASSIFICATION_FUNCTION_SIGNATURES = {
    ...
    ("internal_import", "correct_company_transaction_reporting_item"): (
...
COMPANY_TRANSACTION_CLASSIFICATION_FUNCTION_RESULTS = {
    ...
    ("internal_import", "correct_company_transaction_reporting_item"): "jsonb",
...
MYBANK_CUTOVER_SCHEMA_REVISIONS = frozenset(
    {
        ...
        GENERIC_BANK_STATEMENT_IMPORT_REVISION,
        BOC_ABC_BANK_STATEMENT_IMPORT_REVISION,
        MYBANK_COMPANY_DAILY_STATEMENT_PROFILE_REVISION,
        "20260902_0034",
        ...
        POSTED_SNAPSHOT_TRIGGER_REPAIR_REVISION,
    }
)
...
def _validate_company_transaction_classification_security(
    ...
    if revision < REPORTING_ITEM_CORRECTION_REVISION:
        expected_function_signatures.pop(
            ("internal_import", "correct_company_transaction_reporting_item")
        )
